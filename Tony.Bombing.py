...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("Cyber-tony-BD-71 was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update Cyber-tony-BD-71")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("Cyber-tony-BD-71 is up-to-date")
        mesgdcrt.GeneralMessage("Starting Cyber-tony-BD-71")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Cyber-tony-BD-71 was created by RaviSharma")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("Cyber-tony-BD-71 will work only in Python v3")
    sys.exit()
...
description = """Cyber-tony-BD-71- Your Friendly Spammer Application
Cyber-tony-BD-71 can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....
Cyber-tony-BD-71 is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Ravi Sharma !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start Cyber-tony-BD-71 with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start Cyber-tony-BD-71 with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start Cyber-tony-BD-71 with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update Cyber-tony-BD-71")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current Cyber-tony-BD-71 contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current Cyber-tony-BD-71 version")
